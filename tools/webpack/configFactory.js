          ...
          merge(
            ...
            ifProdClient(() => ({
              loader: ExtractTextPlugin.extract({
                ...
                loader: 'css-loader?sourceMap&importLoaders=2&modules=1&localIdentName=[hash:base64:5]!postcss-loader!sass-loader?outputStyle=expanded&sourceMap&sourceMapContents',
              }),
            })),
            // When targetting the server we use the "/locals" version of the
            // css loader, as we don't need any css files for the server.
            ifNode({
              loaders: ['css-loader/locals?modules=1&localIdentName=[hash:base64:5]', 'postcss-loader', 'sass-loader'],
            }),
          ),
        ),
